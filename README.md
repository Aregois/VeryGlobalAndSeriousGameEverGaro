...
2. Click **Start** to begin the prototype horde mode. Use **WASD** to move, mouse to aim, hold left click to fire, **1/2/3** (top row or numpad) to swap between the revolver, shotgun, and Tommy Gun, **ESC** to pause. Use **Toggle Fullscreen** for an immersive view.
3. Grab pickups between waves to heal, refill shells and SMG ammo, and top up armor. Survive the five test waves (Kamikazes, Kleers, and Bio-Mech turret fire). If you fall, hit **Restart** and dive back in.
